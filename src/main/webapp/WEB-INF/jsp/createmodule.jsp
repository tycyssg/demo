...
<body>
	...
	<div class="container">
		<form:form class="form-horizontal" role="form"  onsubmit="createModuleReceiver(); return false;" id="createModuleForm">
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group">
						<div class="input-group mb-2 mr-sm-2 mb-sm-0">
							...
							<input type="text" name="catname" class="form-control" id="catid"
								placeholder="Pagination Model 1" required autofocus>
						</div>
					</div>
				</div>
				<div class="col-sm-4">
			...
			<div class="row">
				...
				<div class="col-sm-4" style="margin-left: -15px;">
					<button type="submit" class="btn btn-success">
						<i class="fa fa-plus-square" aria-hidden="true"></i> Create Module
					</button>
				</div>
			</div>
		</form:form>
